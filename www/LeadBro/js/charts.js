...
(function () {
  var options = {
    ...
    chart: {
      height: '100%',
      type: window.location.href.split('graphs=')[1] ? window.location.href.split('graphs=')[1] : 'line',
      toolbar: {
        show: false
      },
      fontFamily: 'Inter, sans-serif',
    ...
    xaxis: {
      type: 'category',
      categories: ["12.12", "Sep 19", "Sep 26", "Oct 02", "Oct 09", "Oct 16", "Oct 23", "Oct 30"],
      axisBorder: {
        show: false
      },
      axisTicks: {
  ...
  var chart = document.querySelector('#search-visits');
...
(function () {
  ...
  var chart = document.querySelector('#rejections');
...
(function () {
  ...
  var chart = document.querySelector('#goals');
...
(function () {
  ...
  var chart = document.querySelector('#positions-chart');
